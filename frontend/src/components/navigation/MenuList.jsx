...
const MenuList = ({collapsed, setCollapsed}) => {
  ...
  return (
    ...
    > 
      ...
      <Logo />
      <Menu.Item className={"dashboard-menu-item"} key="/dashboard" icon={<HomeOutlined/>} title="Dashboard" style={{paddingTop: !collapsed ? "40px" : "20px", paddingBottom: !collapsed ? "30px" : "20px"}}> {!collapsed && "Exercise"}</Menu.Item>
