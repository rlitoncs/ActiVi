...
const MenuList = ({collapsed, setCollapsed}) => {
  ...
  return (
    ...
    > 
      ...
      <Logo />
      <Menu.Item className={"dashboard-menu-item"} key="/account/dashboard" icon={<HomeOutlinedIcon style={{fontSize: "30px"}}/>} title="Dashboard" style={{paddingTop: !collapsed ? "40px" : "20px", paddingBottom: !collapsed ? "30px" : "20px"}}> {!collapsed && "Dashboard"}</Menu.Item>
